// Multi-debate system types for frontend
...
export interface DebateRound {
  ...
  debateId: string;
  roundNumber: number;
  moderatorSummary?: string; // Summary from moderator (keeping both names for compatibility)
  moderationSummary?: string; // Alternative name for same field
  currentParticipantId?: string; // ID of participant whose turn it is
  nextParticipantId?: string; // ID of next participant
